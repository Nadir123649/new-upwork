...
const Monitor = () => {
  ...
  const samplePrompts = [
    { title: "AI Ranking", text: "Apple's Overall Catholic Generative AI Ranking" },
    { title: "Detailed Metrics", text: "Explain Tesla's AI, Catholic, and Efficiency Scores" },
    { title: "Scoring System", text: "Explain the detailed calculations in Goldman Sachs Overall Score" }
  ];
            ...
            <div className="message assistant">
              <div className="message-content system-message">
                ...
                <p className="system-description">
                  Provide a query about a public company or generative AI metric. Analyze companies based on AI capabilities, Catholic values, and efficiency metrics.
                </p>
              </div>
            </div>
